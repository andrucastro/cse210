public class Reflecting : Activity{
    ...
    public Reflecting(int activityTime, string activityName) : base( activityTime, activityName){
     ...
     public void displayDescription(){
        Console.WriteLine("This activty will help you reflect on times  in your life  when you shown strength and resilience.\nThis will help you recognize the power you have and how you can use it in other aspects of your life.\n");
    }
    ...
    public void reflect(int seconds){
        ...
        Console.Write("How did you feel it was complete?");
